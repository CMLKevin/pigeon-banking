        ...
        <div className="bg-phantom-bg-secondary/60 backdrop-blur-xl rounded-3xl shadow-card border border-phantom-border p-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-phantom-text-secondary">
                    Sign up with an invite code to receive <span className="text-phantom-accent-primary font-semibold">100 Agon</span> and{' '}
          ...
          <div className="mt-8 text-center">
            <p className="text-phantom-text-secondary">
              ...
              <Link to="/login" className="text-phantom-accent-primary font-semibold hover:text-phantom-purple-light transition-colors">
                Sign In
              </Link>
            </p>
          </div>
